...
class Admin::SitesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create admin_site" do
    assert_difference('Admin::Site.count') do
      post admin_sites_url, params: { admin_site: { code: @admin_site.code, description: @admin_site.description } }
    end
  ...
  test "should update admin_site" do
    patch admin_site_url(@admin_site), params: { admin_site: { code: @admin_site.code, description: @admin_site.description } }
