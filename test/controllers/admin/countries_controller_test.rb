...
class Admin::CountriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create admin_country" do
    assert_difference('Admin::Country.count') do
      post admin_countries_url, params: { admin_country: { code: @admin_country.code, description: @admin_country.description } }
    end
  ...
  test "should update admin_country" do
    patch admin_country_url(@admin_country), params: { admin_country: { code: @admin_country.code, description: @admin_country.description } }
