class Employer::ImmatriculationCooperativesController < Employer::ApplicationController
  ...
  def index
    ...
    if @immatriculation.nil?
      type_employeur = Admin::TypeEmployeur.find_by_code('COOP')
  ...
  def soumettre_demande
    @immatriculation = current_user.immatriculatio
