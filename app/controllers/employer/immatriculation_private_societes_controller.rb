class Employer::ImmatriculationPrivateSocietesController < Employer::ApplicationController
  ...
  def index
    ...
    if @immatriculation.nil?
      type_employeur = Admin::TypeEmployeur.find_by_code('PVT')
  ...
  def valider_infos_societe
    ...
    redirect_to [:employer, 'immatriculation_private_societes'], notice: 'Information sur la société validée.'
  end
  ...
  def valider_salarie
    ...
    if immatriculation.effectif_employe == salaries.size
      ...
      flash[:error] = 'Merci de saisir le nombre de salarié déclar.'
  ...
  def call_web_service_immatriculation
    ...
    #client = Savon.client(wsdl: 'http://192.168.125.23:6500/ouaf/XAIApp/xaiserver/IMMATRICULATION_INBOUND?wsdl',
