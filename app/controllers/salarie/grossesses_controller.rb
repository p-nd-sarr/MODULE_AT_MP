class Salarie::GrossessesController < Salarie::ApplicationController
  ...
  def create
    ...
    if @grossesse.save
      redirect_to salarie_dossier_prestation_allocation_prenatales_path(@dossier_prestation), notice: 'Grossesse was successfully created.'
    else
      render :new
    end
  end
  ...
  def update
    if @grossesse.update(grossesse_params)
      redirect_to salarie_dossier_prestation_allocation_prenatales_path(@dossier_prestation), notice: 'Grossesse was successfully updated.'
    else
      render :edit
    end
  end
  ...
  def destroy
    @grossesse.destroy
    redirect_to salarie_dossier_prestation_grossesses_path(@dossier_prestation), notice: 'Grossesse was successfully destroyed.'
  end
