...
RSpec.describe "prestation_ext_frances/new", type: :view do
  before(:each) do
    assign(:prestation_ext_france, CfsReversionVeuve.new(
      sexe_salarie: 1,
  ...
  it "renders new prestation_ext_france form" do
    render

    assert_select "form[action=?][method=?]", prestation_ext_frances_path, "post" do
