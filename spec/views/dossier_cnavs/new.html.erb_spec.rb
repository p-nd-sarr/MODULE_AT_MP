...
RSpec.describe "dossier_cnavs/new", type: :view do
  before(:each) do
    assign(:dossier_cnav, DossierCnav.new(
  ...
  it "renders new dossier_cnav form" do
    render

    assert_select "form[action=?][method=?]", dossier_cnavs_path, "post" do
