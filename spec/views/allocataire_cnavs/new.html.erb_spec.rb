...
RSpec.describe "allocataire_cnavs/new", type: :view do
  before(:each) do
    assign(:allocataire_cnav, AllocataireCnav.new(
      dossier_cnav: nil,
      numero: "MyString",
      prenom: "MyString",
      nom: "MyString",
  ...
  it "renders new allocataire_cnav form" do
    render

    assert_select "form[action=?][method=?]", allocataire_cnavs_path, "post" do
